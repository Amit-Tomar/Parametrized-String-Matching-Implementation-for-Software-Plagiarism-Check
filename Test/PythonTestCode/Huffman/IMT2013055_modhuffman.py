...
def cmp_freq(char_tup1, char_tup2):
    ...
    '''
    # Your code
    if char_tup1[1] > char_tup2[1]: return 1
    elif char_tup1[1] == char_tup2[1]: return 0
    else : return -1 
...
def build_huffman_tree(freq_table, arity_exp):
    ...
    '''
    # Your code
    modheap.initialize_heap(False, 1, cmp_freq)
    
    for ch in CHAR_TABLE: modheap.DATA.append((ch,CHAR_TABLE[ch]))
    ...
    while(len(heap) >= 1):
        ...
        heap.append(t3)
        stack.extend([(t1[0],t1[1],t3[0],'0'),(t2[0],t2[1],t3[0],'1')])
    stack.append(heap[0])
