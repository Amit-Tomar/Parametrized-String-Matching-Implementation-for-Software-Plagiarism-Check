...
def compress(text_filename, arity_exp):
    ...
    codes,compressed_length=form_codes( root_symbol , code_stack)
    huff_filename = text_filename + '.huff'
    write_compressed(text_filename, huff_filename, codes, compressed_length)
...
def uncompress(huff_filename):
    ...
    ahash , compressed_length = read_codes(huff_file)
