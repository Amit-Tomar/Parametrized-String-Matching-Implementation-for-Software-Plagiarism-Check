...
class Huffman(object):
    ...
    def build_huffman_tree(self, freq_table, arity_exp):
        ...
        while(heap.size()>2):
            ...
            heap.add((tup2[0]+tup1[0], tup1[1]+tup2[1]))
    ...
    def write_compressed(self, text_filename, huff_filename, codes, huff_length):
        ...
        for i in temp:
            ...
            if len(btoa) == 8:
                ...
                btoa = ''
        if len(btoa) != 0:
            self.initi(8 - len(btoa))
            compressed += chr(int(self.pad_to_nbits(btoa, 1, 8-len(btoa)), 2))
    ...
    def compress(self, text_filename, arity_exp):
        ...
        self.write_compressed(text_filename, "testfile.huff", code, count)
    ...
    def uncompress(self, huff_filename):
        ...
        temp1 = ''
        temp2 = ''
        temp = temp[:(len(temp)-self.EXTRA-8)]
        for i in temp:
            temp1 += i
